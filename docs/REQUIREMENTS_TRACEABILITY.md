...
| API 路径、方法、请求 / 响应专业 | REST 风格 Session 资源；统一 `data/error/meta.requestId` 包装 | `docs/API.md`、路由实现 | 完成 |
...
| 一键运行测试 | `npm test`；完整质量门禁见 `docs/TESTING.md` | 完成 |
...
| `/pay` 可重放 cURL / Postman | `scripts/demo-flow.sh`、`docs/DEMO.md` | 完成 |
| 已支付测试 sessionId | `64c41d64-1b86-4be9-b3be-f42a9b456dac`；配套演示 Cookie 见 `docs/DEMO.md` | 完成 |
| GitHub 链接 | <https://github.com/JetSprow/health-assessment-funnel> | 完成 |
| README 启动说明和 API 文档 | `README.md`、`docs/API.md` | 完成 |
| 测试代码、运行方式、覆盖范围 | `tests/`、README、`docs/TESTING.md` | 完成 |
| 数据库 Schema 图 | README Mermaid ER 图；`docs/ARCHITECTURE.md` | 完成 |
| AI 使用复盘 | `docs/AI_RETROSPECTIVE.md`，包括建模、Mock 数据、逻辑、边界测试和明确否决案例 | 完成 |
| 发送至三个指定邮箱 | 邮件正文、收件人和附件命名规则已整理在 `docs/SUBMISSION.md`；需候选人本人填写姓名并发送 | 待人工提交 |
| 文档命名 `【姓名】_全栈挑战_YYYYMMDD` | 命名模板已写入 `docs/SUBMISSION.md`；缺少候选人真实姓名 | 待人工提交 |
